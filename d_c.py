...
def main():
    ...
    server_port = 12345
    input_data = input("Enter plaintext (binary string): ")
    encrypted_data = des_encrypt(input_data, MASTER_KEY)
...
def des_encrypt(input_block, master_key):
...
MASTER_KEY = "1010101010111011000010010001100000100111001101101100110011011101"
